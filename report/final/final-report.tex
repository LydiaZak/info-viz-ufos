...
%\begin{figure}
%\centering
%\caption{Interactive bar graph of the total number of sightings by state}
%\includegraphics[width=3.4in]{sightings_count.png}
%\label{sightings}
%\end{figure}
...
\begin{figure}
\centering
\caption{Interactive national map of sightings with year slider bar and brushable chart of durations and donut chart of shapes of sightings}
\includegraphics[width=3.55in]{map.png}
\label{map}
\end{figure}
...
This visualization was built using HTML, CSS, JavaScript, and several open-source projects including D3 v4, d3-queue. Moment JS, topojson, Underscore JS, Bootstrap, and nodejs.
